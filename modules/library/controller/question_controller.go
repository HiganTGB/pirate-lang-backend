...
//		return controller.BadRequest("Invalid request data", resultValidator.Errors)
//	}
//	question, err := controller.libraryService.CreateQuestion(ctx, requestData, groupId)
//	if err != nil {
...
//}
//func (controller *LibraryController) GetQuestionByGroups(c echo.Context) error {
//	ctx := c.Request().Context()
//	idStr := c.Param("groupId")
//	groupId, errParse := uuid.Parse(idStr)
//	if errParse != nil {
//		return controller.BadRequest("Invalid group ID format", errParse)
//	}
//	response, err := controller.libraryService.GetQuestionsByGroups(ctx, groupId)
//	if err != nil {
//		return controller.BadRequest("Error get question list", err)
//	}
//	return controller.SuccessResponse(c, response, "Get question list successfully")
//}
